...
def get_u_asd_net(img_h=480, img_w=640, img_ch=1, is_multi_output=False, BN=True, is_use_max_unpool=True):
    ...
    #ASD Module
    asd_b1 = Conv2DTranspose(256, (1, 1), strides=(2, 2), padding='same')(fm4_idx4)
    asd_b1 = Conv2D(128, (1, 1),  kernel_initializer=conv_kernel_initializer)(asd_b1)
    asd_b1 = Conv2D(128, (9, 9), padding='same', kernel_initializer=conv_kernel_initializer)(asd_b1)
    asd_b1 = ReLU()(asd_b1)
    ...
    asd_b2 = Conv2DTranspose(256, (1, 1), strides=(2, 2), padding='same')(fm4_idx4)
    asd_b2 = Conv2D(128, (3, 3), padding='same',  kernel_initializer=conv_kernel_initializer)(asd_b2)
    asd_b2 = ReLU()(asd_b2)
    ...
    asd_b3 = Dense(32)(asd_b3)
    asd_b3 = Activation('relu')(asd_b3)
    w = Dense(1)(asd_b3)
    ...
    asd_final = UpSampling2D((4, 4), interpolation='nearest')(asd_b1_b2)
